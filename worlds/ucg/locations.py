...
LOCATION_DATA: dict[str, tuple[int, list[str]]] = {
    ...
    "2-4: Just Zoomin' By Good Rank": (BASE_ID + 3203, ["Go Markers"]),
    ...
    "2-8: Dimlit District Peak Rank": (BASE_ID + 1207, ["Stop Markers", "Go Markers"]),
    "2-8: Dimlit District Good Rank": (BASE_ID + 3207, ["Stop Markers", "Go Markers"]),
    ...
    "2-13: Brawl In The Big City Peak Rank": (BASE_ID + 1212, ["Keys", "Jump Pads", "Go Markers", "Stop Markers"]),
    "2-13: Brawl In The Big City Good Rank": (BASE_ID + 3212, ["Keys", "Jump Pads", "Go Markers", "Stop Markers"]),
    ...
    "2-15: Back In The Back Alley Peak Rank": (BASE_ID + 1214, ["Keys", "Jump Pads", "Stop Markers", "Go Markers"]),
    "2-15: Back In The Back Alley Good Rank": (BASE_ID + 3214, ["Keys", "Jump Pads", "Stop Markers", "Go Markers"]),
    ...
    "3-17: Racetrack Chasetrack Peak Rank": (BASE_ID + 1316, ["Keys", "Dog", "Jump Pads", "Go Markers", "Stop Markers"]),
    "3-17: Racetrack Chasetrack Good Rank": (BASE_ID + 3316, ["Keys", "Dog", "Jump Pads", "Go Markers", "Stop Markers"]),
    ...
    "E-7: The Key to Failure Peak Rank": (BASE_ID + 1707, ["Keys", "Jump Pads"]),
    "E-7: The Key to Failure Good Rank": (BASE_ID + 3707, ["Keys", "Jump Pads"]),
